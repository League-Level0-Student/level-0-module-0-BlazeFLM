...
public class DragonFight {
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You were defeated by the dragon, no treasure for you.");	
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "Your new name is Dragonslayer123 and you get a ton of gold.");
